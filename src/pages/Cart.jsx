...
import image1 from "../assets/images/buug1.jpeg"
...
const Cart = () => {
  ...
  return (
    <div className='container mx-auto py-8 min-h-96 px-4 md:px-16 lg:px-24'>
        ...
        <div>
            <h3 className='text-2xl font-semibold mb-4'>Book Cart</h3>
            <div className='flex flex-col md:flex-row justify-between space-x-10 mt-8'>
                <div className='md:w-2/3'>
                    <div className='flex justify-between border-b items-center mb-4 text-xs font-bold'>
                        ...
                        <div>
                            {cart.products.map((product) => (
                                <div
                                    key={product.id} className='flex items-center justify-between p-3 border-b'>
                    ...
                    <div className='md:w-1/3 bg-white p-6 rounded-lg shadow-md border'>
                        ...
                        onClick={() => navigate('/checkout')}>Proced to checkout</button>
                    </div>
                </div>
          ...
          : <div className='flex justify-center'>
            <img src={image1} alt={image1} className='h-96' />
            </div>}
    </div>
  )
}
